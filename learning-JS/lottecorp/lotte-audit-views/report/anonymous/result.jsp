...
<%@ include file="/WEB-INF/views/common/taglibs.jsp"%>
	...
	<div id="container" class="container">
		...
		<form id="anonymousResultForm" name="anonymousResultForm" method="post">	
		...
		<div class="content">
			...
			<div class="form-submit-area">
				...
				<div class="btn-area">
					<button type="button" class="btn-type-3" id="btnModify" name="btnModify" onclick="javascrpit:go_anonymousReportUpdate();"><spring:message code="label_result_update" /></button>
...
<script type="text/javascript">
	...
	//수정
	function go_anonymousReportUpdate(){
		var form = $('#anonymousResultForm')[0];
		form.action = "/report/anonymous/update.do";
		form.submit();
	}
</script>
