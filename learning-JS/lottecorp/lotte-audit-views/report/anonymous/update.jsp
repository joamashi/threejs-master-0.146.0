		...
		<div class="audit-form-area">			
			...
			<ul class="fieldset-area">
				...
				<li>
					...
					<div class="input-box-area">
						<span class="text-area w-240"><input type="text" name="report_target" id="report_target" maxlength="20" value="<c:out value='${list.tgtEnm}'/>" ></span>
					</div>
				</li>
				<li>
					<label for="report_dept"><spring:message code="label_dept" /></label>
					<div class="input-box-area">
						<span class="text-area w-240"><input type="text" name="report_dept" id="report_dept" maxlength="50" value="<c:out value='${list.tgtDnm}'/>" ></span>
					</div>
				</li>
				<li>
					<label for="report_posit"><spring:message code="label_posit" /></label>
					<div class="input-box-area">
						<span class="text-area w-240"><input type="text" name="report_posit" id="report_posit" maxlength="40" value="<c:out value='${list.tgtEcls}'/>" ></span>
					</div>
				</li>
			</ul>
		</div>	
...
<script type="text/javascript">
	...
	$(function(){
		...
		$('html > head > title').text('<spring:message code="site_update_anonymous_title" />');
    ...
    function fnUpdateReport() {
		...
		if(isChecked){
			...
			if(reportEmail != "" && reportHP != ""){
				if($("#report_agree01").val() == "0" || $("#report_agree01").val() == "0"){
			...
			$.ajax({
	            url : '/report/anonymous/updateAnonymous.json'
