...
<spring:eval expression="@properties['recaptcha.sitekey']" var="key"/>
	...
	<div id="container" class="container">
	    ...
	    <input type="hidden" id="report_type" name="report_type" value="real"/>
				...
				<ul class="fieldset-area">
					<li>
						...
						<div class="input-box-area">
							<span class="text-area w-240"><input type="text" name="report_name" id="report_name" maxlength="20" disabled></span>
						</div>
					</li>
					<li>
						<label for="report_relationship_selbox"><spring:message code="label_relationship" /><em class="required">*</em></label>
						<div class="input-box-area">							
							<span class="select-area w-240" onclick="javacript:goCheckPolicy();">
			...
			<div class="audit-form-area">
				...
				<ul class="fieldset-area">
					<li>
						...
						<div class="input-box-area">
							...
							<button 
									...
									id="btn-real-company"
									onclick="fnCompanyPop(this);"
									 disabled><spring:message code="label_company_all" /></button>
						</div>
					</li>
					<li class="tex-area">
						<div>
					...
					<li>
						...
						<div class="input-box-area">
							<span class="select-area w-240">
								<select id="report_consulting_selbox" name="report_consulting_selbox" disabled>
			...
			<div class="audit-form-area">
				...
				<ul class="fieldset-area">
					...
					<li>
						...
						<div class="input-box-area">
							<span class="textarea-area w-full"><textarea name="report_content" id="report_content"></textarea></span>
						</div>
					</li>
					<li class="space">
						<p class="txt"></p>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$('html > head > title').text('<spring:message code="site_write_real_title" />');
		            ...
		            ,success: function (result) { */
						...
						if(reportEmail != ""){
		           	    ...
		           	    if(isChecked){
		           			...
		           			$.ajax({
		           	            url : '/report/real/insertReal.json'
    ...
    function goCheckPolicy(){
    	 var agree = $("#report_agree01").val();
    	 if(agree != "1"){
         	alert('<spring:message code="label_agree_02" />');
         	$("#btn-agree").focus();
         	return false;
         }
    }
